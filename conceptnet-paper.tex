...
those that were used in building ConceptNet Numberbatch and a recently-released
system that was not. The systems we evaluate are:
...
released their data in English, so we instead look up the published results of
other systems as a comparison.
