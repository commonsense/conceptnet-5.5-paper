...
We demonstrate our multilingual performance with the Spanish translation of
WordSim-353 \cite{hassan2009crosslingual} and the set of 350 German word pairs
known as Gur350 \cite{gurevych2005german}.  The systems we compare to have only
released their data in English, but we can at least compare to the multilingual
results {\em reported} by fastText \cite{fasttext}. In this evaluation only, we
...
\item Similarly, we did not use the Gur350 German pairs in development.
\end{itemize}
